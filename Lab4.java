...
public class Lab4 {
    ...
    public static void main(String[] args) {
        ...
        // Print the tree using breadth-first traversal (BFS)
        tree.printBreadthFirst();
        
        // Search for specific values in the tree and print the results
        System.out.println(tree.search(12));
        System.out.println(tree.search(3));
    }

    /** Create a List of Integers from a given file path with data
